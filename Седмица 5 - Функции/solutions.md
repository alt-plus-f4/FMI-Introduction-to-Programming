...
Какво правим в този код: умножаваме с 10 **повдигнато на степен** k - където k = **дължината на числото** b. Дали може да използваме някои функции, които вече сме написали? Много ясно :D  
...
```
**Задача 10**  
Логическият израз, който трябва да симулираме, е (`[a,b]` обединено с `[c,d]`) без `[e,f]` `<==>` (`x` е в `[a,b]` или `x` е в `[c,d]`) и `х` не е в `[e,f]`.  
